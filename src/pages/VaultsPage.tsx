  ...
  return (
    <div style={{ fontFamily: F }}>
      ...
      <motion.div
        ...
        style={{ textAlign: 'center', padding: '2px 16px 24px', position: 'relative', marginBottom: 0 }}
      >
        ...
        {/* Badge */}
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '5px 14px', borderRadius: 100, background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', marginBottom: 8 }}>
          ...
          <span style={{ fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.85)', letterSpacing: '0.15em', textTransform: 'uppercase' }}>Institutional Grade</span>
        </div>
        ...
        <h1 style={{ fontFamily: F, fontSize: 'clamp(32px, 5vw, 48px)', fontWeight: 700, color: '#fff', letterSpacing: '-0.025em', lineHeight: 1.08, margin: '0 0 14px' }}>
          Professional <span style={{ color: '#d6ff34' }}>Yield</span> for{' '}
        ...
        <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: 15, fontWeight: 400, margin: '0 auto 16px', lineHeight: 1.65 }}>
      ...
      <section style={{ marginBottom: 24 }}>
        <div style={{ textAlign: 'center', marginBottom: 20 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: 13, fontWeight: 400, margin: '0 0 14px' }}>
